...
class PvetController extends Controller
{
    ...
    public function __construct(Request $request)
    {
        ...
        $this->base['page_title'] = 'Pvet Collection';
    }
    /**
    ...
    public function index()
    {
        ...
        $yr = $dt->format('Y');
        $mnth = $dt->format('m');
        $this->base['sub_header'] = 'Pvet Collection';
        ...
        return view('collection::pvet.index', $this->base)->with('base', $this->base);
    }
    ...
    public function edit($id)
    {
        ...
        return view('collection::pvet.edit')->with('base', $this->base);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($validator->fails()) {
            return redirect()->route('pvet.edit', ['receipt' => $id])
