...
class HospitalRemittanceController extends Controller
{
    ...
    public function __construct(Request $request)
    {
        ...
        $this->base['page_title'] = 'District Hospital Remittance';
    }
    /**
    ...
    public function index()
    {
        ...
        return view('collection::hospital.index', $this->base)->with('base', $this->base);
    }
    ...
    public function show($id)
    {
        ...
        return view('collection::hospital.view')->with('base', $this->base);
    }
    ...
    public function edit($id)
    {
        ...
        return view('collection::hospital.edit')->with('base', $this->base);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($validator->fails()) {
            return redirect()->route('hospital.edit', ['receipt' => $id])
    ...
    public function report()
    {
        ...
        $this->base['page_title'] = 'Hospital Report';
        ...
        return view('collection::hospital.report')->with('base', $this->base);
    }
