<div class="col-md-12">
    <form method="GET"  action="{{ route('pdf.land_tax_collection2',[$base['receipt']->id]) }}">
        ...
        <div class="form-group col-sm-1">
            <a class="btn btn-info" href="{{route('pdf.form56_certificate',$base['receipt']->id)}}" @if($base['cert_paid'] != \Carbon\Carbon::parse($base['receipt']->report_date)->format('Y')) disabled @endif>CERTIFICATE</a>
        </div>
</div>