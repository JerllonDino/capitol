            ...
            @if($year <= $entry_year || (count($kk) == 1 && $year > $entry_year))
                ...
                <table width="100%" style="margin: 4px 55px 0 8px; border-color: #ffffff00; background-color: ##42cbf4; position: absolute; top: 130px;" >
                                                        ...
                                                        @if($year_to == $entry_year)
                                                            ...
                                                            @else
                                                                @if(isset($annual_arp[$this_arp][$year]))
                                                                    {{ number_format($annual_arp[$this_arp][$year]['assess_val']*.01, 2) }}
                                                                    {{ number_format($annual_arp[$this_arp][$year]['assess_val']*.01, 2) }}
                                                                @else
                                                            ...
                                                            @else
                                                                @if(isset($annual_arp[$this_arp_next][$year]))
                                                                    {{ number_format($annual_arp[$this_arp_next][$year]['assess_val']*.01, 2) }}
                                                                    {{ number_format($annual_arp[$this_arp_next][$year]['assess_val']*.01, 2) }}
                                                                @else
                                                            ...
                                                            @else
                                                                @if(isset($annual_arp[$this_arp][$year]))
                                                                    @if($annual_arp[$this_arp][$year]['penalty'])
                                                                        <?php
                                                                            $compute = round(floatval($annual_arp[$this_arp][$year]['assess_val']*.01), 2) + round(floatval($annual_arp[$this_arp][$year]['penalty']), 2);
                                                                    ...
                                                                    @elseif($annual_arp[$this_arp][$year]['discount'])
                                                                        <?php
                                                                            $compute = round(floatval($annual_arp[$this_arp][$year]['assess_val']*.01), 2) - round(floatval($annual_arp[$this_arp][$year]['discount']), 2);
                                                                            $limit_total += $compute*2;
                                                                        ?>
                                                                        {{ number_format($compute, 2) }}<br>
                                                                        {{ number_format($compute, 2) }}<br>
                                                    ...
                                                    @else
                                                        ...
                                                        @if($val['to'] > $entry_year) 
                                                            @if($annual_per_arp['yearly'][$this_arp][$year]['penalty'] > 0)
                                                                <?php
                                                                    $curr_yr = $entry_year;
                                                                    $prev_penalty = round(floatval($annual_arp[$this_arp][$year]['penalty']), 2) - round(floatval($annual_per_arp['yearly'][$this_arp][$curr_yr]['penalty']), 2);
                                                                    // $compute1 = round(floatval($annual_per_arp['yearly'][$this_arp][$year]['sef'])*$diff, 2) + round(floatval($prev_penalty), 2); 
                                                                    $compute1 = (round(floatval($total_sef), 2) + round(floatval($annual_per_arp['yearly'][$this_arp][$curr_yr]['sef']), 2)) + (round(floatval($total_penalty), 2) + round(floatval($annual_per_arp['yearly'][$this_arp][$curr_yr]['penalty']), 2)); 
                                                        ...
                                                        @else
                                                            @if(strlen($year) > 4)
                                                                @if(isset($annual_arp[$this_arp][$year]))
                                                                    ...
                                                                    @else
                                                                        ...
                                                                        ?>
                                                                        {{ number_format($annual_arp[$this_arp][$year]['sef'], 2) }}<br>a
                                                                        {{ number_format($annual_arp[$this_arp][$year]['sef'], 2) }}<br>
                                                                    @endif
                                                                @else
                                                                    @if($annual_arp[$this_arp][$year]['penalty'] > 0)
                                                            ...
                                                            @else
                                                                <?php
                                                                    ...
                                                                    $total_discount = 0;
                                                                    $total_penalty = 0;
                                                                    foreach($annual_per_arp['yearly'] as $arppp => $data) {
                                                                        foreach($data as $yearrr => $value) {
                                                                            $total_sef += $value['sef'];
                                                                            $total_discount += $value['discount'];
                                                                            $total_penalty += $value['penalty'];
                    ...
                    <tr class="" style="background: ##c542f5;">
                        ...
                        <!-- padding-top: -38px; -->
                        <td colspan="7" class="border-hidden text-right" style="background-color: ##7fe83e; padding-top: -55px;"><span class="text-hidden">TOTAL ></span> {{ number_format($limit_total, 2) }}</td> 
                    </tr>
                    <tr>
                ...
                @if($year >= $entry_year_adv)
                    ...
                    <table width="100%" class="border-hidden" style="margin: 0 ; background: ##dbba7d; position: absolute; top: -15px;">
                        ...
                        <tr>
                            ...
                            <td class="border-hidden" style="padding-left: -30px;">{{ $total_words }} only</td>
                            <td class="border-hidden text-right" style="text-indent: 13px; padding-right: 25px;"><br />{{ number_format($form56['total'], 2) }}</td>
                        </tr>
                        <tr>
                            <td colspan=2 class="border-hidden" height="28">
                                <?php
                    ...
                    <table width="100%" style="margin: 4px 55px 0 8px; border-color: #ffffff00; background-color: ##42cbf4; position: absolute; top: 130px;" >
                        ...
                        <tr style="background: ##ef7385;">
                            <td class="border-hidden text-left vertical-top" style="height: 155px; padding-left: 20px; background: ##ef7865;">
                                @if(isset($annual_per_arp[$arp]['owner']))
                                {{ $annual_per_arp[$arp]['owner'] }}
                                @endif
                            </td>
                            ...
                            <!-- width: 1cm; -->
                            <td class="border-hidden text-left vertical-top" style="background: ##689cf2; padding-left: -70px;" colspan="2">
                                @if($limit_counter <= $limit)                                 
                                    @foreach($annual_arp as $this_arp => $data)
                                        <?php 
                                            // next($annual_arp);
                            ...
                            <!-- LAND -->
                            <!-- padding-left: -10px; -->
                            <td class="border-hidden text-right vertical-top" style="width: 1.3cm; background: ##4cef9b; padding-left: -78px; padding-right: 10px;">
                                @if(isset($annual_per_arp[$arp]['assess_val_class']))
                                    @foreach($annual_per_arp[$arp]['assess_val_class'] as $index => $val)
                                        @if(!is_null($val['kind']))
                                            @if(preg_match('/building/i', $val['kind']) != 1)
                                                                ...
                                                                <?php 
                                                                    ...
                                                                    if($this_arp2 == $this_arp || $this_arp2 == $this_arp_next) {                  
                                                                        foreach($data2 as $year2 => $val2) {
                                                                            ...
                                                                            if(strlen($year2) > 4) {
                                                                                if($year2 >= $entry_year_adv) 
                                                                                    $year_to = $year2 > $year_to ? $year2 : $year_to;   
                                                                            } else {
                                                                                $y = explode('-', $year2);
                                                                                if ($y[0] >= $entry_year_adv)
                                                                                    $year_to = $year2 > $year_to ? $year2 : $year_to;
                                                                            }
                                                        ...
                                                        @if($annual_per_arp[$this_arp]['prev_tax_dec_no'] == $this_arp_next || $annual_per_arp[$this_arp_next]['prev_tax_dec_no'] == $this_arp)
                                                            @if($year_to > 0)  
                                                                ...
                                                                @else
                                                                    ...
                                                                    ?>
                                                                    @if(isset($annual_per_arp['yearly'][$this_arp][$year_ex[1]]))
                                                                        @if($annual_per_arp['yearly'][$this_arp][$year_ex[1]]['penalty'] > 0)
                                                                            {{ number_format($annual_per_arp['yearly'][$this_arp][$year_ex[1]]['penalty']) }}<br>
                                                                            {{ number_format($annual_per_arp['yearly'][$this_arp][$year_ex[1]]['penalty']) }}<br>
                                                                        @endif

                                                                        @if($annual_per_arp['yearly'][$this_arp][$year_ex[1]]['discount'] > 0)
                                                                            {{ number_format($annual_per_arp['yearly'][$this_arp][$year_ex[1]]['discount']) }}<br>
                                                                            {{ number_format($annual_per_arp['yearly'][$this_arp][$year_ex[1]]['discount']) }}<br>
                                                                        @endif
                                                                    @elseif(isset($annual_per_arp['yearly'][$this_arp_next][$year_ex[1]]))
                                                                        @if($annual_per_arp['yearly'][$this_arp_next][$year_ex[1]]['penalty'] > 0)
                                                                            {{ number_format($annual_per_arp['yearly'][$this_arp_next][$year_ex[1]]['penalty']) }}<br>
                                                                            {{ number_format($annual_per_arp['yearly'][$this_arp_next][$year_ex[1]]['penalty']) }}<br>
                                                                        @endif

                                                                        @if($annual_per_arp['yearly'][$this_arp_next][$year_ex[1]]['discount'] > 0)
                                                                            {{ number_format($annual_per_arp['yearly'][$this_arp_next][$year_ex[1]]['discount']) }}<br>
                                                                            {{ number_format($annual_per_arp['yearly'][$this_arp_next][$year_ex[1]]['discount']) }}<br>
                                                                        @endif
                                                                    @endif
                                                                @endif
