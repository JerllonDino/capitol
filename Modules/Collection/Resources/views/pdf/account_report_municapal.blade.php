...
<html>
<head>
    <title>ACCOUNTS REPORT Municipal Income</title>
...
<div class="header">
    ...
    <tr>
        ...
        <td>
        REPORT OF ACCOUNTS (MUNICIPAL SHARE)<br />
                            ...
                            <tr class="page-break">
                                ...
                                @for( $x = 0 ; $x<=$data['diff']; $x++)
                                    ...
                                    <?php
                                        ...
                                        $subtitle_total = $subs->receipt()->where('col_receipt.report_date','LIKE',$asdate[$x]['y-m-d'].'%' )->where('col_receipt.is_cancelled','=','0')->where('col_receipt.is_printed','=','1')->select(["col_receipt_items.share_municipal","col_receipt_items.value"])->get();
