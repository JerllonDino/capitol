...
<body>
    ...
    <table class="border_all_table">
            ...
            {{ $rcpt_done = 0 }}
                ...
                @foreach ($receipt->f56detail->TDARP as $tan)
                    ...
                    <tr>
                        ...
                        <td class="border_all">{{ $receipt->barangay->name }}</td>
        ...
        <tr>
            <span class="hidden">
            {{ $munshare_basic_current = number_format($total_basic_current * .4, 2) }}
            {{ $munshare_basic_discount = number_format($total_basic_discount * .4, 2) }}
            {{ $munshare_basic_previous = number_format($total_basic_previous * .4, 2) }}
            {{ $munshare_basic_penalty_current = number_format($total_basic_penalty_current * .4, 2) }}
            {{ $munshare_basic_penalty_previous = number_format($total_basic_penalty_previous * .4, 2) }}
            {{ $munshare_basic_net = number_format($total_basic_net * .4, 2) }}
            
            {{ $brgyshare_basic_current = number_format($total_basic_current * .25, 2) }}
            {{ $brgyshare_basic_discount = number_format($total_basic_discount * .25, 2) }}
            {{ $brgyshare_basic_previous = number_format($total_basic_previous * .25, 2) }}
            {{ $brgyshare_basic_penalty_current = number_format($total_basic_penalty_current * .25, 2) }}
            {{ $brgyshare_basic_penalty_previous = number_format($total_basic_penalty_previous * .25, 2) }}
            {{ $brgyshare_basic_net = number_format($total_basic_net * .25, 2) }}
            </span>
            <th colspan="4"></th>
        ...
        <tr>
            ...
            <td colspan="2" class="border_all val">{{ $munshare_basic_current }}</td>
            <td colspan="2" class="border_all val">{{ $munshare_basic_discount }}</td>
            <td class="border_all ctr">40%</td>
            <td colspan="2" class="border_all val">{{ $munshare_basic_previous }}</td>
            <td class="border_all ctr">40%</td>
            <td colspan="3" class="border_all val">{{ $munshare_basic_penalty_current }}</td>
            <td colspan="2" class="border_all val">{{ $munshare_basic_penalty_previous }}</td>
            <td colspan="2" class="border_all val">{{ $munshare_basic_net }}</td>
        </tr>
        <tr>
            <th colspan="4"></th>
            <td colspan="3">Barangay Share</td>
            <td class="border_all ctr">25%</td>
            <td colspan="2" class="border_all val">{{ $brgyshare_basic_current }}</td>
            <td colspan="2" class="border_all val">{{ $brgyshare_basic_discount }}</td>
            <td class="border_all ctr">25%</td>           
            <td colspan="2" class="border_all val">{{ $brgyshare_basic_previous }}</td>
            <td class="border_all ctr">25%</td>           
            <td colspan="3" class="border_all val">{{ $brgyshare_basic_penalty_current }}</td>
            <td colspan="2" class="border_all val">{{ $brgyshare_basic_penalty_previous }}</td>
            <td colspan="2" class="border_all val">{{ $brgyshare_basic_net }}</td>
        </tr>
        <tr>
            <th colspan="4"></th>
