...
<div class="footer">
 ...
 <h4><strong>DATE :  {{\Carbon\Carbon::parse($datex)->format('F Y')}}  </strong></h4>
...
<table class="table table-condensed table-hover table-bordered page-break">
        ...
        <tbody>
        <tr class="page-break" ><td colspan="7" class="title"  >{{ $title->description }}</td></tr>
                    ...
                    ?>
                        @if(count($receipt->items) == 0)
                            ...
                            <tr class="page-break">
                                ...
                                <td class="text-center">{!! $receipt->nature !!}</td>
                                <td class="text-right">{{ number_format( $receipt->{$sharing} ,2) }}</td>
                            </tr>
                            <?php $count++; ?>
                        @else
