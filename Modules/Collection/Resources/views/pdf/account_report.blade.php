                            ...
                            <td><div class="col-sm-11 col-sm-offset-1">{{ $title->name }}</div></td>
                                @for( $x = 0 ; $x<=$data['diff']; $x++)
                                    ...
                                    <?php
                                        ...
                                        $title_total = $title->receipt()->where('col_receipt.report_date','LIKE',$asdate[$x]['y-m-d'].'%' )->where('col_receipt.is_cancelled','=','0')->where('col_receipt.is_printed','=','1')->select(["col_receipt_items.share_provincial"])->get();
                            ...
                            <tr class="page-break">
                                ...
                                @for( $x = 0 ; $x<=$data['diff']; $x++)
                                    ...
                                    <?php
                                        ...
                                        $subtitle_total = $subs->receipt()->where('col_receipt.report_date','LIKE',$asdate[$x]['y-m-d'].'%' )->where('col_receipt.is_cancelled','=','0')->where('col_receipt.is_printed','=','1')->select(["col_receipt_items.share_provincial"])->get();
