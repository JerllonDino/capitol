    ...
    <div class="form-group col-sm-12">
        <div class="form-inline">
            <div class="form-group">
                <label>Year</label>
                <input type="number" name="year" id="year" class="form-control" value="{{ \Carbon\Carbon::now()->format('Y') }}">
            </div>
        </div>
        <br><br>
        <div class="col-md-12">
        ...
        $.fn.loadTbl = function() {
            ...
            $('#mncpal_tbl').DataTable({
                ...
                columns: [
                    ...
                    { data: null, render: 
                        function(data) {
                            var view_route = "{{ route('mncpal.rcpt.view', 'id') }}";
                            var view_route2 = view_route.replace('id', data.id);
                            var edit_route = "{{ route('mncpal.rcpt.edit', 'id') }}";
                            var edit_route2 = edit_route.replace('id', data.id);
                            var cert_route = "{{ route('mncpal.cert', 'id') }}";
