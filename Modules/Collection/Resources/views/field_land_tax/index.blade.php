        ...
        <table class="table" id="table">
            <thead>
                <tr>
                    ...
                    <th>Amount</th>
                    <th><button id="add_row" class="btn btn-sm btn-success" type="button" data-transactionType="1"><i class="fa fa-plus"></i></button></th>
                </tr>
            </thead>
            <tfoot>
                <tr>
...
$.fn.loadTable = function(){
  if ( $.fn.DataTable.isDataTable('#seriallist') ) {
    ...
    $('#seriallist').dataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: { 'url' : '{{ route("collection.datatables", "field_land_tax") }}',
                ...
                function(data) {
                    ...
                    if(data.col_receipt_serial_parent != null ){
                        if(data.col_receipt_serial_parent == data.serial_no ){
                            cert = (data.is_cancelled == 0) ? '<a href="{{ route('field_land_tax.index') }}/'+data.id+'" class="btn btn-sm btn-red datatable-btn" title="'+data.cert_typex+' Certificate"><i class="fa fa-certificate"></i></a>' : '';
                        }
                    }else{
                        var cert_type = '';
                        ...
                        if(data.with_cert != null) {
                            ...
                            if(data.with_cert.process_status == '0'){
                                cert = (data.is_cancelled == 0) ? '<a href="{{ route('field_land_tax.index') }}/'+data.id+'" class="btn btn-sm btn-gray datatable-btn" title="'+data.with_cert.cert_type+' Certificate"><i class="fa fa-certificate"></i></a>' : '';
                            }else if(data.with_cert.process_status == '1'){
                                cert = (data.is_cancelled == 0) ? '<a href="{{ route('field_land_tax.index') }}/'+data.id+'" class="btn btn-sm '+cert_color+' datatable-btn" title="'+data.with_cert.cert_type+' Certificate"><i class="fa fa-certificate"></i></a>' : '';
                            }else if(cert_type != ''){
                                cert = (data.is_cancelled == 0) ? '<a href="{{ route('field_land_tax.index') }}/'+data.id+'" class="btn btn-sm '+cert_color+' datatable-btn" title="'+cert_type+' Certificate"><i class="fa fa-certificate"></i></a>' : '';
                            }else{
                                cert = (data.is_cancelled == 0) ? '<a href="{{ route('field_land_tax.index') }}/'+data.id+'" class="btn btn-sm btn-gray datatable-btn" title="Certificate"><i class="fa fa-certificate"></i></a>' : '';
                            }
                    ...
                    // }
                     ...
                     @if ( Session::get('permission')['col_receipt'] & $base['can_write'] )
                       if(data.is_printed == 1){
                            if(data.col_receipt_serial_parent == null)
                                another = (data.is_cancelled == 0) ? '<a href="{{ route('field_land_tax.index') }}/'+data.id+'/another?types=field" class="btn btn-sm btn-another-none datatable-btn" title="ANOTHER RECEIPT"><i class="fa fa-plus"></i></a>' : '';
                            else
                                if(data.col_receipt_serial_parent == data.serial_no ){
                                another = (data.is_cancelled == 0) ? '<a href="{{ route('field_land_tax.index') }}/'+data.id+'/another?types=field" class="btn btn-sm btn-another datatable-btn" title="PARENT : '+data.col_receipt_serial_parent+'"><i class="fa fa-plus"></i></a>' : '';
                                }else{
                    ...
                    @if ( Session::get('permission')['col_receipt'] & $base['can_write'] )
                       if(data.is_printed == 1){
                            if(data.col_receipt_serial_parent == null){
                                ...
                                another = (data.is_cancelled == 0) ? '<a href="{{ route('field_land_tax.index') }}/'+data.id+'/another" class="btn btn-sm btn-another-none datatable-btn" title="ANOTHER RECEIPT"><i class="fa fa-plus"></i></a>' : '';
                            }else{
                                if(data.col_receipt_serial_parent == data.serial_no ){
                                    ...
                                    another = (data.is_cancelled == 0) ? '<a href="{{ route('field_land_tax.index') }}/'+data.id+'/another" class="btn btn-sm btn-another datatable-btn" title="PARENT : '+data.col_receipt_serial_parent+'"><i class="fa fa-plus"></i></a>' : '';
                                }else{
