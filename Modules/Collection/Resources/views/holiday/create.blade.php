...
@section('content')
<div class="row">
    {{ Form::open([ 'method' => 'POST', 'route' => 'holiday_settings.store' ]) }}
    
    <div class="form-group col-sm-6">
        <label for="Code">Year</label>
        <input type="number" class="form-control year_month" step="1" name="year" id="year" value="{{ date('Y') }}" required autofocus>
    </div>
