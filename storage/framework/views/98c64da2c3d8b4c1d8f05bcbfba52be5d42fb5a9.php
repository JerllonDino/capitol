...
<div style="text-align: center;">
    ...
    <br>
    <h5><b>Month of <?php echo e(\Carbon\Carbon::parse($date)->format('F, Y')); ?></b></h5>
    <br>
    <p style="display: inline-block; padding-right: 30px;">Accountable Officer: <u><b><?php echo e($accountable_officer['value']); ?></b></u></p>
    <p style="display: inline-block; padding-right: 30px;">Designation: <u><b><?php echo e($acctble_officer_position['value']); ?></b></u></p>
...
<table class="table page-break table-condensed table-bordered">
    <thead>
        ...
        <?php $i = 0; ?>
        <?php foreach($category as $catkey => $catvalue): ?>
            <?php $j = 0; ?>
            <?php if($catvalue->id != 2): ?>
                <!-- BTS combined w/ Gen. Fund -->
                <?php foreach($rcpt_acct51[$catvalue->name] as $rcpt): ?>
                <?php 
                    // if($rcpt['end_qty'] <= 0)
                    //     continue;
        ...
        <tr class="page-break">
            ...
            <td class="text-center val"><b><?php echo e($beg_total51); ?></b></td>
            <td class="text-center val"></td>
            <td class="text-center val"></td>
            <td class="text-center val"><b><?php echo e($rec_total51); ?></b></td>
            <td class="text-center val"></td>
            <td class="text-center val"></td>
            <td class="text-center val"><b><?php echo e($iss_total51); ?></b></td>
            <td class="text-center val"></td>
            <td class="text-center val"></td>
            <td class="text-center val"><b><?php echo e($end_total51); ?></b></td>
            <td class="text-center val"></td>
            <td class="text-center val"></td>
            <td></td>
        </tr>
            ...
            <?php 
                ...
                $j = ''; 
            ?>
            <?php foreach($rcpt_acct56 as $rcpt): ?>
            <tr>
                <td class="form_type">
                    <?php if($i == 0): ?>
                        AF No. 56
                ...
                <td class="text-center val" ><?php echo e($rcpt['iss_from']); ?></td>
                <td class="text-center val" ><?php echo e($rcpt['iss_to']); ?></td>
                <td class="text-center val" ><?php echo e($rcpt['end_qty']); ?></td>
                <td class="text-center val" ><?php echo e($rcpt['end_from']); ?></td>
                <td class="text-center val" ><?php echo e($rcpt['end_to']); ?></td>
                <td class="text-center val">
                    ...
                    ?>
                    <?php if(strcasecmp($j, $rcpt['src']) != 0): ?>
                        <b><?php echo e($rcpt['src']); ?></b>
                    <?php endif; ?>
                </td>
            </tr>
            <?php $i++; $j = $rcpt['src']; ?>
            ...
            <tr>
                ...
                <td class="text-center val" ><b><?php echo e($beg_total56); ?></b></td>
                <td class="text-center val" ></td>
                <td class="text-center val" ></td>
                <td class="text-center val" ><b><?php echo e($rec_total56); ?></b></td>
                <td class="text-center val" ></td>
                <td class="text-center val" ></td>
                <td class="text-center val" ><b><?php echo e($iss_total56); ?></b></td>
                <td class="text-center val" ></td>
                <td class="text-center val" ></td>
                <td class="text-center val" ><b><?php echo e($end_total56); ?></b></td>
                <td class="text-center val" ></td>
                <td class="text-center val" ></td>
                <td></td>
            </tr>
    ...
    <div style="text-align: center;">
        ...
        <div style="display: inline-block; padding-right: 100px; vertical-align: top;">
            <u><b><?php echo e($accountable_officer['value']); ?></b></u>
            <br>
            <small>Name & Signature of the Accountable Officer</small>
        </div> 
        <div style="display: inline-block; vertical-align: top;"> 
            <u><b><?php echo e(\Carbon\Carbon::now()->format('F j, Y')); ?></b></u>
        </div>
        </center>
    </div>
</body>
