...
<div class="row">
    <?php echo e(Form::open(['method' => 'GET', 'route' => ['pdf.real_property'], 'id' => 'pdf_rpt'])); ?>

        <div class="form-group col-sm-6">
            <label for="municipality">Municipality</label>
            <select class="form-control" name="municipality" id="municipality" required>
                <?php foreach($base['municipalities'] as $mun): ?>
        ...
        <div class="form-group col-sm-2">
            ...
            <input type="text" class="form-control" name="report_no" id="report_no" value="<?php echo e(date('Y')); ?>" required>
        </div>
...
<br>
<div class="row">
    <?php echo e(Form::open(['method' => 'GET', 'route' => ['pdf.real_property_consolidated']])); ?>
...
<br>
<div class="row">
    <?php echo e(Form::open(['method' => 'GET', 'route' => ['pdf.real_property_p2']])); ?>
    ...
    <div class="modal-dialog modal-lg" role="dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="<?php echo e(route('rpt.submit')); ?>" id="form">
...
<script>
    ...
    $(document).on('click', '.rpt_report', function(e) {
        ...
        $.ajax({
            'url' : '<?php echo e(route("rpt.prepare")); ?>', 
            'data' : {
