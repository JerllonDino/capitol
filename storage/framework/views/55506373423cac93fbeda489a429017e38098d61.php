...
<div class="row">
        <div class="form-group col-sm-12">
            ...
            <?php if( Session::get('permission')['col_field_land_tax'] & $base['can_write'] ): ?>
                    <a href="<?php echo e(route('form56.edit','')); ?>/<?php echo e($base['receipt']->id); ?>" class="btn  btn-info datatable-btn" title="Edit"><i class="fa fa-pencil-square-o"></i></a>
            <?php endif; ?>
        <?php if($base['receipt']->is_printed == 1 && $base['receipt']->is_cancelled == 0): ?>
        ...
        <?php endif; ?>
         ...
         <?php echo $__env->make('collection::form56/settings/form_print', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            ...
            <dd>
                ...
                ?>
                <?php echo e(isset($base['receipt_tdarp']->previous_tax_type_id) ? $tax_types[$base['receipt_tdarp']->previous_tax_type_id] : ''); ?>

            </dd>
            <dt>Remark</dt>
            <dd><?php echo e(isset($base['receipt']) ? $base['receipt']->bank_remark : ''); ?></dd>
            <dt>Status</dt>
            <dd>
        ...
        <table class="table" id="tablex">
            ...
            <tbody>
                ...
                ?>
                        ...
                        <tr>
                            <td><?php echo e($F56Detail->owner_name); ?></td>
                            <td><?php echo e($F56Detail->TDARPX->tdarpno); ?></td>
                            <td><?php echo e(isset($F56Detail->TDARPX->barangay_name) ? $F56Detail->TDARPX->barangay_name->name : ''); ?></td>
                            <td><?php echo e(($F56Detail->F56Type->name)); ?></td>
                            <td><?php echo e(($F56Detail->tdrp_assedvalue)); ?></td>
                            <td><?php echo e(($F56Detail->period_covered)); ?></td>
                            <td>
                                <?php echo e($full_partial); ?>

                                <?php if(!is_null($F56Detail->ref_num)): ?>
                                    <br>(Referred OR: <?php echo e($F56Detail->ref_num); ?>)
                                <?php endif; ?>
                            </td>
                            <td><?php echo e(($F56Detail->basic_current)); ?></td>
                            <td><?php echo e(($F56Detail->basic_discount)); ?></td>
                            <td><?php echo e(($F56Detail->basic_previous)); ?></td>
                            <td><?php echo e(($F56Detail->basic_penalty_current)); ?></td>
                            <td><?php echo e(($F56Detail->basic_penalty_previous)); ?></td>
                        </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
   ...
   <table class="table table-bordered table-condensed">
    ...
    <tbody>
         <?php
            ...
            $gt_net = 0;
      ?>
         <?php foreach( $base['receipt']->F56Detailmny as $key => $f56_detail ): ?>
         ...
         <?php
            ...
            <tr>
                <td><?php echo e($f56_detail->TDARPX->tdarpno); ?></td>
                <td class="border_all val"><?php echo e(number_format($f56_detail->basic_current, 2)); ?></td>
                <td class="border_all val"><?php echo e(number_format($f56_detail->basic_discount, 2)); ?></td>
                <td class="border_all val"><?php echo e(number_format($f56_detail->basic_previous, 2)); ?></td>
                <td class="border_all val"><?php echo e(number_format($f56_detail->basic_penalty_current, 2)); ?></td>
                <td class="border_all val"><?php echo e(number_format($f56_detail->basic_penalty_previous, 2)); ?></td>
                <td class="border_all val"><?php echo e(number_format($basic_gross, 2)); ?></td>
                <td class="border_all val"><?php echo e(number_format($basic_net, 2)); ?></td>
                <td class="border_all val"><?php echo e(number_format($f56_detail->basic_current, 2)); ?></td>
                <td class="border_all val"><?php echo e(number_format($f56_detail->basic_discount, 2)); ?></td>
                <td class="border_all val"><?php echo e(number_format($f56_detail->basic_previous, 2)); ?></td>
                <td class="border_all val"><?php echo e(number_format($f56_detail->basic_penalty_current, 2)); ?></td>
                ...
                <td class="border_all val"><?php echo e(number_format($basic_gross, 2)); ?></td>
                <td class="border_all val"><?php echo e(number_format($basic_net, 2)); ?></td>
                <td class="border_all val"><?php echo e(number_format(($basic_gross + $basic_gross), 2)); ?></td>
                <td class="border_all val"><?php echo e(number_format(($basic_net + $basic_net), 2)); ?></td>
            </tr>
        <?php endforeach; ?>
    </tbody>
</table>
...
$('#add_row_form56').click( function() {
    ...
    var add_tdarp = '<tr>'+
                        ...
                        '<td>'+
                            ...
                            '</select>'+
                        '</td>'+
                        '<td><input type="text" class="form-control period_covered" name="period_covered[]" value="<?php echo e(date('Y')); ?>" required></td>'+
                        '<td>'+
...
$.fn.loadTable = function(){
  if ( $.fn.DataTable.isDataTable('#seriallist') ) {
    ...
    $('#seriallist').dataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: { 'url' : '<?php echo e(route("collection.datatables", "form56")); ?>',
                ...
                function(data) {
                    ...
                    <?php endif; ?>
                     ...
                     if(data.process_status == '0'){
                             ...
                             cert = (data.is_cancelled == 0) ? '<a href="<?php echo e(route('receipt.index')); ?>/'+data.id+'/certificate?types=field" class="btn btn-sm btn-green datatable-btn" title="'+data.cert_type+' Certificate"><i class="fa fa-certificate"></i></a>' : '';
                        }else if(data.col_rcpt_certificate_type_id != null){
                             cert = (data.is_cancelled == 0) ? '<a href="<?php echo e(route('receipt.index')); ?>/'+data.id+'/certificate?types=field" class="btn btn-sm btn-green datatable-btn" title="'+data.cert_typex+' Certificate"><i class="fa fa-certificate"></i></a>' : '';
                        }else{
                            cert = (data.is_cancelled == 0) ? '<a href="<?php echo e(route('receipt.index')); ?>/'+data.id+'/certificate?types=field" class="btn btn-sm btn-gray datatable-btn" title="Certificate"><i class="fa fa-certificate"></i></a>' : '';
                        }

                     <?php if( Session::get('permission')['col_receipt'] & $base['can_write'] ): ?>
                       if(data.is_printed == 1){
                            if(data.col_receipt_serial_parent == null)
                                another = (data.is_cancelled == 0) ? '<a href="<?php echo e(route('receipt.index')); ?>/'+data.id+'/another?types=field" class="btn btn-sm btn-another-none datatable-btn" title="ANOTHER RECEIPT"><i class="fa fa-plus"></i></a>' : '';
                            else
                                if(data.col_receipt_serial_parent == data.serial_no ){
                                another = (data.is_cancelled == 0) ? '<a href="<?php echo e(route('receipt.index')); ?>/'+data.id+'/another?types=field" class="btn btn-sm btn-another datatable-btn" title="PARENT : '+data.col_receipt_serial_parent+'"><i class="fa fa-plus"></i></a>' : '';
                            }else{
