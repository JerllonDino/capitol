...
<div class="row">
    <?php echo e(Form::open([ 'method' => 'POST', 'route' => ['holiday_settings.update', $base['year'], $base['month'] ]])); ?>

    
    <div class="form-group col-sm-6">
        <label for="Code">Year</label>
        <input type="number" class="form-control year_month" step="1" name="year" id="year" value="<?php echo e(date('Y')); ?>" required readonly>
    </div>
        ...
        <table class="table" id="days">
            ...
            <?php for($x=1; $x<=$base['current_month_days']; $x++): ?>
                ...
                <tr>
                    ...
                    <td>
                        <div class="checkbox">
                            <?php if(in_array($x, $base['days'])): ?>
                            <label><input type="checkbox" value="<?php echo e($x); ?>" name="holiday_date[]" checked>Holiday</label>
                            <?php else: ?>
