...
$.fn.animateWidth();
var hostss = 'http://<?php echo e($base['host']); ?>';
           ...
           { data: 'date_of_entry',name : 'date_of_entry',
            ...
            { data:
                function(data) {
                    ...
                    view = '<a href="<?php echo e(route('form56.view',"")); ?>/'+data.id+'" class="btn btn-sm btn-info datatable-btn" title="View"><i class="fa fa-eye"></i></a>';
                    <?php endif; ?>

                    <?php if( Session::get('permission')['col_field_land_tax'] & $base['can_write'] ): ?>
                    write = (data.is_cancelled == 0) ? '<a href="<?php echo e(route('form56.edit',"")); ?>/'+data.id+'" class="btn btn-sm btn-info datatable-btn" title="Edit"><i class="fa fa-pencil-square-o"></i></a>' : '';
                    <?php endif; ?>
...
<script type="text/javascript">
    ...
    //   $.ajax({
    //     'url': "<?php echo e(route('f56.rcpt_prev')); ?>",
    //     'data': {
