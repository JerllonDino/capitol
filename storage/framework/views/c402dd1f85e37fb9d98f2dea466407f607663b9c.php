...
<table class="table table-condensed table-hover table-bordered page-break">
        ...
        <tbody>
        <tr class="page-break" ><td colspan="7" class="title"  ><?php echo e($title->name); ?> <?php echo e($stitle); ?></td></tr>
...
<table class="table table-condensed table-hover table-bordered page-break">
        ...
        <tbody>
        <tr class="page-break" ><td colspan="7" class="title"  ><?php echo e($title->name); ?></td></tr>
                        ...
                        <?php foreach($cashdiv->items as $keyi => $valuei ): ?>
                            ...
                            ?>
                             <tr class="page-break" >
                                ...
                                <td class="text-left"><?php echo e($valuei->nature); ?></td>
        ...
        <tfoot>
            ...
            <?php foreach($acct_totalcd as $key => $value): ?>
             <tr class="page-break" >
                ...
                <td colspan="4" class="text-right total"><?php echo e(number_format( $value  ,2)); ?></td>
            </tr>
            <?php endforeach; ?>
