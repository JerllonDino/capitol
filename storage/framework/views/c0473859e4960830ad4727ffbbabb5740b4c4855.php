...
<table class="table table-condensed table-hover table-bordered page-break">
        ...
        <tbody>
        <tr class="page-break" ><td colspan="8" class="title"  ><?php echo e($title->name); ?></td></tr>
                ...
                <?php foreach($receipt->items as $keyi => $valuei ): ?>
                    ...
                    ?>
                     <tr class="page-break" >
                        ...
                        <!--<td class="text-right" ><?php /* number_format( $valuei->value ,2) */ ?></td>-->
...
<table class="table table-condensed table-hover table-bordered page-break">
        ...
        <tr class="page-break" ><td colspan="6" class="title"  ><?php echo e($title->name); ?></td></tr>
          ...
          <?php foreach($cash_divs as $ckey => $cashdiv): ?>
            ...
            <?php  
                $datex =  \Carbon\Carbon::parse($cashdiv->date_of_entry);
                $rcpt_donecd = 0;
                // if($countcd == 2) {
                // dd($cash_divs);
                // }
