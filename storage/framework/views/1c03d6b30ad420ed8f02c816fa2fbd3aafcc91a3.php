...
$('#pc_mac_address').dataTable({
      ...
      ajax:{
        "type": 'POST',
        "url" : '<?php echo e(route('collection.set_datatables')); ?>',
        data : {
              "dataTables"        : 'pc_macs',
...
$.fn.sentNewPCmac = function(){
  ...
  $.ajax({
          type: 'POST',
          url: '<?php echo e(route('settings_access.set_pc')); ?>',
...
$.fn.sentNewPCmacf56 = function(){
  ...
  $.ajax({
          type: 'POST',
          url: '<?php echo e(route('settings_access.set_pcf56')); ?>',
          data: $('#new_pc_form').serialize(),
          dataType: "json",
          error: function(){
              alert('error');
...
$.fn.sentUpdatePCmacf56 = function(){
  ...
  $.ajax({
          type: 'POST',
          url: '<?php echo e(route('settings_access.update_pcf56')); ?>',
          data: $('#new_pc_form').serialize(),
          dataType: "json",
          error: function(){
              alert('error');
...
$.fn.deletePc = function(pc_mac_id){
  $.ajax({
          type: 'POST',
          url: '<?php echo e(route('settings_access.delete_pc_id')); ?>',
          data: {
              _token : '<?php echo e(csrf_token()); ?>',
              pc_mac_id : pc_mac_id
          },
...
$.fn.updatePc = function(pc_mac_id){
  $.ajax({
          type: 'POST',
          url: '<?php echo e(route('settings_access.get_pc_edit')); ?>',
          data: {
              _token : '<?php echo e(csrf_token()); ?>',
              pc_mac_id : pc_mac_id
          },
...
$.fn.updatePc56 = function(pc_mac_id,mncpal_name){
  $.ajax({
          type: 'POST',
          url: '<?php echo e(route('settings_access.get_pc_edit56')); ?>',
          data: {
              _token : '<?php echo e(csrf_token()); ?>',
              pc_mac_id : pc_mac_id,
...
$.fn.getSerials = function(serial_def = ''){
   $.ajax({
          type: 'POST',
          url: '<?php echo e(route('settings_access.get_pc_serials')); ?>',
          data: {
              _token : '<?php echo e(csrf_token()); ?>',
...
$.fn.getF56Serials = function(serial_def = ''){
  $.ajax({
          type: 'POST',
          url: '<?php echo e(route('settings_access.get_pc_serialsf56')); ?>',
          data: {
              _token : '<?php echo e(csrf_token()); ?>',
              form : $('#pc_process_form').val()
          },
