...
<body>
    <table class="center">
        ...
        <?php if(isset($mun->name)): ?>
        <tr>
            <td>MUNICIPALITY OF <?php echo e(strtoupper($mun->name)); ?></td>
        </tr>
        <?php endif; ?>
        <tr>
            <td><?php echo e($date_range); ?></td>
        </tr>
    </table>
    ...
    <table>
        <tr>
            ...
            <td width="35%"></td>
            <?php if(isset($report_no)): ?>
            <td>Report No.</td>
            <td><?php echo e($report_no); ?></td>
            <?php endif; ?>
        </tr>
        <tr>
            <td>A. COLLECTIONS</td>
    ...
    <table class="border_all_table">
        <thead>
            ...
            <tr>
                ...
                <th rowspan="3"><?php echo e($preceeding); ?></th>
            ...
            <tr>
                ...
                <th rowspan="2"><?php echo e($preceeding); ?></th>
            ...
            <tr>
                ...
                <th><?php echo e($prior_start); ?>-1992</th>
                <th>1991 & Below</th>
                <th><?php echo e($prior_start); ?>-1992</th>
                <th>1991 & Below</th>
        ...
        <tbody>
            ...
            <?php foreach($receipts as $receipt): ?>
                ...
                <?php if($receipt->is_cancelled): ?>
                    <tr>
                        <td><?php echo e(date('M d', strtotime($receipt->date_of_entry))); ?></td>
                        <td colspan="2" style="color:red;">Cancelled</td>
                        <td colspan="1" style="color:red;"><?php echo e($receipt->serial_no); ?></td>
                        <td colspan="31" style="color:red;"></td>
                    </tr>
                <?php elseif($receipt->F56Detailmny()->count() > 0): ?>
                    <?php foreach($receipt->F56Detailmny as $f56_detail): ?>
                    <?php
                        $counter++; 
                        // current
                    ...
                    <tr>
                        <?php if($rcpt_done == 0): ?>
                            <?php $rcpt_done = 1; ?>
                            <td>
                                <?php if($entry_date->format('M') == 'Sep'): ?>
                                    Sept <?php echo e(date('d', strtotime($receipt->date_of_entry))); ?>

                                <?php else: ?>
                                    <?php echo e(date('M d', strtotime($receipt->date_of_entry))); ?>

                                <?php endif; ?>
                            </td>
                            <td><?php echo e($f56_detail->owner_name); ?></td>
                            <td><?php echo e($f56_detail->period_covered); ?></td>
                        ...
                        <?php if(!isset($f56_detail->TDARP[0])): ?>
                            <td></td>
                            <td></td>
                            <td></td>
                            <td></td>
                            ...
                            <td></td>
                        <?php else: ?>
                            <td><?php echo e($f56_detail->TDARP[0]->tdarpno); ?></td>
                            <td><?php echo e(isset($f56_detail->TDARPX->barangay_name->name) ? $f56_detail->TDARPX->barangay_name->name : ''); ?></td>
                            <td><?php echo e($f56_detail->F56Type->abbrev); ?></td>
                            <td>
                                <?php if($f56_detail->period_covered >= $advance_yr): ?>
                                    <?php echo e(number_format($f56_detail->basic_current, 2)); ?>
                            ...
                            <td>
                                <?php if($f56_detail->period_covered >= $advance_yr): ?>
                                    <?php echo e(number_format($f56_detail->basic_discount, 2)); ?>
                            ...
                            <td>
                                <?php if($f56_detail->period_covered == $current): ?>
                                    <?php echo e(number_format($f56_detail->basic_current, 2)); ?>
                            ...
                            <td>
                                <?php if($f56_detail->period_covered == $preceeding): ?>
                                    <?php echo e(number_format($f56_detail->basic_previous, 2)); ?>
                            ...
                            <td>
                                <?php if($f56_detail->period_covered <= $prior_start && $f56_detail->period_covered >= 1992): ?>
                                    <?php echo e(number_format($f56_detail->basic_previous, 2)); ?>
                            ...
                            <td>
                                <?php if($f56_detail->period_covered <= $prior_start && $f56_detail->period_covered <= 1991): ?>
                                    <?php echo e(number_format($f56_detail->basic_previous, 2)); ?>
                            ...
                            <td><?php echo e(number_format($f56_detail->basic_penalty_current, 2)); ?></td>
                            <td>
                                <?php if($f56_detail->period_covered == $preceeding): ?>
                                    <?php echo e(number_format($f56_detail->basic_penalty_previous, 2)); ?>
                            ...
                            <td><?php echo e(number_format($basic_gross, 2)); ?></td>
                            <td><?php echo e(number_format($basic_net, 2)); ?></td>
                            <td>
                                <?php if($f56_detail->period_covered >= $advance_yr): ?>
                                    <?php /* number_format(($f56_detail->tdrp_assedvalue*.01), 2) */ ?>
                                    <?php echo e(number_format($f56_detail->basic_current, 2)); ?>
                            ...
                            <td>
                                <?php if($f56_detail->period_covered >= $advance_yr): ?>
                                    <?php /* number_format((($f56_detail->tdrp_assedvalue*.01)*.10), 2) */ ?>
                                    <?php echo e(number_format($f56_detail->basic_discount, 2)); ?>
                            ...
                            <td><?php echo e(number_format($basic_gross, 2)); ?></td>
                            <td><?php echo e(number_format($basic_net, 2)); ?></td>
                            <td><?php echo e(number_format($basic_gross*2, 2)); ?></td>
                            <td><?php echo e(number_format($basic_net*2, 2)); ?></td>
                        <?php endif; ?>
                    </tr>
                    <?php endforeach; ?>
                <?php endif; ?>
            ...
            <tr>
                ...
                <th><?php echo e(number_format($total_adv, 2)); ?></th>
                <th><?php echo e(number_format($total_adv_discount, 2)); ?></th>
                <th><?php echo e(number_format($total_basic_current, 2)); ?></th>
                <th><?php echo e(number_format($total_basic_discount, 2)); ?></th>
                <th><?php echo e(number_format($total_basic_previous, 2)); ?></th>
                <th><?php echo e(number_format($total_prior_1992, 2)); ?></th>
                <th><?php echo e(number_format($total_prior_1991, 2)); ?></th>
                <th><?php echo e(number_format($total_basic_penalty_current, 2)); ?></th>
                <th><?php echo e(number_format($total_basic_penalty_previous, 2)); ?></th>
                <th><?php echo e(number_format($total_penalty_prior_1992, 2)); ?></th>
                <th><?php echo e(number_format($total_penalty_prior_1991, 2)); ?></th>
                <th><?php echo e(number_format($total_basic_gross, 2)); ?></th>
                <th><?php echo e(number_format($total_basic_net, 2)); ?></th>
                <th><?php echo e(number_format($total_adv, 2)); ?></th>
                <th><?php echo e(number_format($total_adv_discount, 2)); ?></th>
                <th><?php echo e(number_format($total_basic_current, 2)); ?></th>
                <th><?php echo e(number_format($total_basic_discount, 2)); ?></th>
                ...
                <th><?php echo e(number_format($total_basic_gross, 2)); ?></th>
                <th><?php echo e(number_format($total_basic_net, 2)); ?></th>
                <th><?php echo e(number_format($gt_gross, 2)); ?></th>
                <th><?php echo e(number_format($gt_net, 2)); ?></th>
            </tr>
            <tr>
                <td colspan="35"></td>
            </tr>
    ...
    <table class="table">
        ...
        <tr>
            ...
            <td colspan="2"><?php echo e($type->name); ?></td>
            <!-- BASIC -->
            <!-- advance -->
            <td class="border_all val"><?php echo e(number_format($class_amt[$type->id]['basic_adv'], 2)); ?></td>
            <td class="border_all val"><?php echo e(number_format($class_amt[$type->id]['basic_adv_discount'], 2)); ?></td>
            <!-- current --> 
            <td class="border_all val"><?php echo e(number_format($class_amt[$type->id]['basic_current'], 2)); ?></td>
            <td class="border_all val"><?php echo e(number_format($class_amt[$type->id]['basic_discount'], 2)); ?></td>
            <!-- immediate preceeding year --> 
            <td class="border_all val"><?php echo e(number_format($class_amt[$type->id]['basic_previous'], 2)); ?></td>
            <!-- prior years -->
            <td class="border_all val"><?php echo e(number_format($class_amt[$type->id]['basic_prior_1992'], 2)); ?></td>
            <td class="border_all val"><?php echo e(number_format($class_amt[$type->id]['basic_prior_1991'], 2)); ?></td>
            <!-- penalties -->
            <td class="border_all val"><?php echo e(number_format($class_amt[$type->id]['basic_penalty_current'], 2)); ?></td>
            <td class="border_all val"><?php echo e(number_format($class_amt[$type->id]['basic_penalty_previous'], 2)); ?></td>
            <td class="border_all val"><?php echo e(number_format($class_amt[$type->id]['basic_prior_penalty_1992'], 2)); ?></td>
            <td class="border_all val"><?php echo e(number_format($class_amt[$type->id]['basic_prior_penalty_1991'], 2)); ?></td>
            <!-- subtotal gross -->
            <td class="border_all val"><?php echo e(number_format($class_basic_gross, 2)); ?></td>
            <!-- subtotal net -->
            <td class="border_all val"><?php echo e(number_format($class_basic_net, 2)); ?></td>
            <!-- SEF --> 
            <!-- advance -->
            <td class="border_all val"><?php echo e(number_format($class_amt[$type->id]['basic_adv'], 2)); ?></td>
            <td class="border_all val"><?php echo e(number_format($class_amt[$type->id]['basic_adv_discount'], 2)); ?></td>
            ...
            <td class="border_all val"><?php echo e(number_format($class_basic_net, 2)); ?></td>
            <!-- grandtotal gross -->
            <td class="border_all val"><?php echo e(number_format($class_total_gross, 2)); ?></td>
            <!-- grandtotal net -->
            <td class="border_all val"><?php echo e(number_format($class_total_net, 2)); ?></td>
        </tr>
        <?php endforeach; ?>
        <tr>
            <td colspan="5"></td>
            <th class="border_all" colspan="2">TOTAL</th>
            <th class="border_all val"><?php echo e(number_format($total_adv, 2)); ?></th>
            <th class="border_all val"><?php echo e(number_format($total_adv_discount, 2)); ?></th>
            <th class="border_all val"><?php echo e(number_format($total_basic_current, 2)); ?></th>
            <th class="border_all val"><?php echo e(number_format($total_basic_discount, 2)); ?></th>
            <th class="border_all val"><?php echo e(number_format($total_basic_previous, 2)); ?></th>
            <th class="border_all val"><?php echo e(number_format($total_prior_1992, 2)); ?></th>
            <th class="border_all val"><?php echo e(number_format($total_prior_1991, 2)); ?></th>
            <th class="border_all val"><?php echo e(number_format($total_basic_penalty_current, 2)); ?></th>
            <th class="border_all val"><?php echo e(number_format($total_basic_penalty_previous, 2)); ?></th>
            <th class="border_all val"><?php echo e(number_format($total_penalty_prior_1992, 2)); ?></th>
            <th class="border_all val"><?php echo e(number_format($total_penalty_prior_1991, 2)); ?></th>
            <th class="border_all val"><?php echo e(number_format($total_basic_gross, 2)); ?></th>
            <th class="border_all val"><?php echo e(number_format($total_basic_net, 2)); ?></th>
            <th class="border_all val"><?php echo e(number_format($total_adv, 2)); ?></th>
            <th class="border_all val"><?php echo e(number_format($total_adv_discount, 2)); ?></th>
            <th class="border_all val"><?php echo e(number_format($total_basic_current, 2)); ?></th>
            <th class="border_all val"><?php echo e(number_format($total_basic_discount, 2)); ?></th>
            ...
            <th class="border_all val"><?php echo e(number_format($total_basic_gross, 2)); ?></th>
            <th class="border_all val"><?php echo e(number_format($total_basic_net, 2)); ?></th>
            <th class="border_all val"><?php echo e(number_format($gt_gross, 2)); ?></th>
            <th class="border_all val"><?php echo e(number_format($gt_net, 2)); ?></th>
        </tr>
        <tr>
            <td colspan="5"></td>
    ...
    <div>
        <table class="table dis-pgbreak">
            ...
            <tr>
                ...
                <th colspan="3" class="border_all ctr"><?php echo e($preceeding); ?></th>
                <th colspan="3" class="border_all ctr"><?php echo e($prior_start); ?>-1992</th>
            ...
            <tr>
                ...
                <th colspan="2" class="border_all ctr"><?php echo e($preceeding); ?></th>
                <th colspan="2" class="border_all ctr"><?php echo e($prior_start); ?>-1992</th>
            ...
            <tr>
                ...
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['prv_adv_ammount'], 2)); ?></td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['prv_adv_discount'], 2)); ?></td>
                <!-- current --> 
                <td class="border_all ctr">35%</td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['prv_crnt_ammount'], 2)); ?></td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['prv_crnt_discount'], 2)); ?></td>
                <!-- previous -->
                <td class="border_all ctr">35%</td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['prv_prvious_ammount'], 2)); ?></td>
                <!-- 1992-above -->
                <td class="border_all ctr">35%</td>
                <td class="border_all val" colspan="2"><?php echo e(number_format($merged['prv_prior_1992_amt'], 2)); ?></td>
                <!-- 1991-below -->
                <td class="border_all ctr">35%</td>
                <td class="border_all val" colspan="2"><?php echo e(number_format($merged['prv_prior_1991_amt'], 2)); ?></td>
                <!-- penalties -->
                <td class="border_all ctr">35%</td>
                <td colspan="3" class="border_all val"><?php echo e(number_format($merged['prv_pnalties_crnt'], 2)); ?></td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['prv_pnalties_prvious'], 2)); ?></td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['prv_prior_1992_penalties'], 2)); ?></td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['prv_prior_1991_penalties'], 2)); ?></td>
                <!-- total -->
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['prv_total_basic'], 2)); ?></td>
            </tr>
            <tr>
                <th colspan="4"></th>
                ...
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['mnc_adv_ammount'], 2)); ?></td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['mnc_adv_discount'], 2)); ?></td>
                <!-- current -->
                <td class="border_all ctr">40%</td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['munshare_basic_current'], 2)); ?></td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['munshare_basic_discount'], 2)); ?></td>
                <!-- previous -->
                <td class="border_all ctr">40%</td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['munshare_basic_previous'], 2)); ?></td>
                <!-- 1992-above -->
                <td class="border_all ctr">40%</td>
                <td class="border_all val" colspan="2"><?php echo e(number_format($merged['mnc_prior_1992_amt'], 2)); ?></td>
                <!-- 1991-below -->
                <td class="border_all ctr">40%</td>
                <td class="border_all val" colspan="2"><?php echo e(number_format($merged['mnc_prior_1991_amt'], 2)); ?></td>
                <!-- penalties -->
                <td class="border_all ctr">40%</td>
                <td colspan="3" class="border_all val"><?php echo e(number_format($merged['munshare_basic_penalty_current'], 2)); ?></td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['munshare_basic_penalty_previous'], 2)); ?></td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['mnc_prior_1992_penalties'], 2)); ?></td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['mnc_prior_1991_penalties'], 2)); ?></td>
                <!-- total -->
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['mncpal_total_basic'], 2)); ?></td>
            </tr>      
            <tr>
                <th colspan="4"></th>
                ...
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['brgy_adv_ammount'], 2)); ?></td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['brgy_adv_discount'], 2)); ?></td>
                <!-- current --> 
                <td class="border_all ctr">25%</td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['brgyshare_basic_current'], 2)); ?></td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['brgyshare_basic_discount'], 2)); ?></td>
                <!-- previous -->
                <td class="border_all ctr">25%</td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['brgyshare_basic_previous'], 2)); ?></td>
                <!-- 1992-above -->
                <td class="border_all ctr">25%</td>
                <td class="border_all val" colspan="2"><?php echo e(number_format($merged['brgy_prior_1992_amt'], 2)); ?></td>
                <!-- 1991-below -->
                <td class="border_all ctr">25%</td>
                <td class="border_all val" colspan="2"><?php echo e(number_format($merged['brgy_prior_1991_amt'], 2)); ?></td>
                <!-- penalties -->
                <td class="border_all ctr">25%</td>
                <td colspan="3" class="border_all val"><?php echo e(number_format($merged['brgyshare_basic_penalty_current'], 2)); ?></td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['brgyshare_basic_penalty_previous'], 2)); ?></td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['brgy_prior_1992_penalties'], 2)); ?></td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['brgy_prior_1991_penalties'], 2)); ?></td>
                <!-- total -->
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['brgy_total_basic'], 2)); ?></td>
            </tr>     
            <tr>
                <th colspan="4"></th>
                ...
                <td class="border_all val" colspan="2"><?php echo e(number_format($merged['total_adv_amt'], 2)); ?></td>
                <td class="border_all val" colspan="2"><?php echo e(number_format($merged['total_adv_discount'], 2)); ?></td>
                <!-- current -->
                <td class="border_all"></td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['total_basic_current'], 2)); ?></td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['total_basic_discount'], 2)); ?></td>
                <!-- previous -->
                <td class="border_all"></td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['total_basic_previous'], 2)); ?></td>
                <!-- 1992-above -->
                <td class="border_all"></td>
                <td class="border_all val" colspan="2"><?php echo e(number_format($merged['total_prior_1992_amt'], 2)); ?></td>
                <!-- 1991-below -->
                <td class="border_all"></td>
                <td class="border_all val" colspan="2"><?php echo e(number_format($merged['total_prior_1991_amt'], 2)); ?></td>
                <!-- penalties -->
                <td class="border_all"></td>
                <td colspan="3" class="border_all val"><?php echo e(number_format($merged['total_basic_penalty_current'], 2)); ?></td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['total_basic_penalty_previous'], 2)); ?></td>
                <td class="border_all val" colspan="2"><?php echo e(number_format($merged['total_prior_1992_penalties'], 2)); ?></td>
                <td class="border_all val" colspan="2"><?php echo e(number_format($merged['total_prior_1991_penalties'], 2)); ?></td>
                <!-- total -->
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['total_basic_net'], 2)); ?></td>
            </tr>            
            <tr>
                <td colspan="7"></td>
            ...
            <tr>
                ...
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['sef_prv_adv_amt'], 2)); ?></td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['sef_prv_adv_discount'], 2)); ?></td>
                <!-- current -->
                <td class="border_all ctr">50%</td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['sef_prv_amt'], 2 )); ?></td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['sef_prv_discount'], 2)); ?></td>
                <!-- previous -->
                <td class="border_all ctr">50%</td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['sef_prev_prv_amt'], 2)); ?></td>
                <!-- 1992-above -->
                <td class="border_all ctr">50%</td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['sef_prv_prior_1992_amt'], 2)); ?></td>
                <!-- 1991-below -->
                <td class="border_all ctr">50%</td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['sef_prv_prior_1991_amt'], 2)); ?></td>
                <!-- penalties -->
                <td class="border_all ctr">50%</td>
                <td colspan="3" class="border_all val"><?php echo e(number_format($merged['sef_prv_penalty'], 2)); ?></td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['sef_prev_prv_penalty'], 2)); ?></td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['sef_prv_prior_1992_penalties'], 2)); ?></td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['sef_prv_prior_1991_penalties'], 2)); ?></td>
                <!-- total -->
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['sef_prv_net'], 2)); ?></td>
            </tr>
            <tr>
                <th colspan="4"></th>
                <td colspan="3">Municipal Share</td>
                <!-- advance -->
                <td class="border_all ctr">50%</td>
                <td class="border_all val" colspan="2"><?php echo e(number_format($merged['sef_mnc_adv_amt'], 2)); ?></td>
                <td class="border_all val" colspan="2"><?php echo e(number_format($merged['sef_mnc_adv_discount'], 2)); ?></td>
                <!-- current -->
                <td class="border_all ctr">50%</td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['sef_mncpl_crnt'],2)); ?></td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['sef_mncpl_dscnt'],2)); ?></td>
                <!-- previous -->
                <td class="border_all ctr">50%</td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['sef_mncpl_prev'],2)); ?></td>
                <!-- 1992-above -->
                <td class="border_all ctr">50%</td>
                <td class="border_all val" colspan="2"><?php echo e(number_format($merged['sef_mnc_prior_1992_amt'], 2)); ?></td>
                <!-- 1991-below -->
                <td class="border_all ctr">50%</td>
                <td class="border_all val" colspan="2"><?php echo e(number_format($merged['sef_mnc_prior_1991_amt'], 2)); ?></td>
                <!-- penalties -->
                <td class="border_all ctr">50%</td>
                <td colspan="3" class="border_all val"><?php echo e(number_format($merged['sef_mncpl_pen_crnt'],2)); ?></td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['sef_mncpl_pen_crnt_prev'],2)); ?></td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['sef_mnc_prior_1992_penalties'], 2)); ?></td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['sef_mnc_prior_1991_penalties'], 2)); ?></td>
                <!-- total -->
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['sef_total_basic_net'],2)); ?></td>
            </tr>
            <tr>
                <th colspan="4"></th>
                <th colspan="3">TOTAL(S)</th>
                <!-- advance --> 
                <td class="border_all"></td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['sef_total_adv_amt'], 2)); ?></td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['sef_total_adv_discount'], 2)); ?></td>
                <!-- current -->
                <td class="border_all"></td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['sef_curr_total'], 2)); ?></td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['sef_curr_discount_total'], 2)); ?></td>
                <!-- previous -->
                <td class="border_all"></td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['sef_prev_total'], 2)); ?></td>
                <!-- 1992-above -->
                <td class="border_all"></td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['sef_total_prior_1992_amt'], 2)); ?></td>
                <!-- 1991-below -->
                <td class="border_all"></td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['sef_total_prior_1991_amt'], 2)); ?></td>
                <!-- penalties -->
                <td class="border_all"></td>
                <td colspan="3" class="border_all val"><?php echo e(number_format($merged['sef_curr_pen_total'], 2)); ?></td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['sef_prev_penalty_total'], 2)); ?></td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['sef_total_prior_1992_penalties'], 2)); ?></td>
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['sef_total_prior_1991_penalties'], 2)); ?></td>
                <!-- total -->
                <td colspan="2" class="border_all val"><?php echo e(number_format($merged['gtotal_sef'], 2)); ?></td>
            </tr>
            <tr>
                <td colspan="7"></td>
                <td colspan="31" class="border_all"></td>
